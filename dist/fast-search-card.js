class FastSearchCard extends HTMLElement {
    ...
    getFilterMenuHTML() {
    return `
        <div class="filter-menu-header" style="padding: 24px; border-bottom: 1px solid rgba(255,255,255,0.1); display: flex; align-items: center; flex-shrink: 0;">

            <button class="close-button" id="fullscreen-close-btn" style="background: rgba(0,0,0,0.15); border: none; border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; cursor: pointer; color: rgba(255,255,255,0.8); margin-right: 16px; z-index: 10000; position: relative;">
                ←
            </button>
        ...
        <div class="filter-menu-content" style="padding: 24px; max-height: calc(70vh - 160px); overflow-y: auto; flex: 1;">
            ...
            <div style="margin-bottom: 32px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px;">
                    ...
                    <div class="filter-option selected" data-type="entities" style="background: rgba(255,255,255,0.15); border: 2px solid rgba(66,133,244,1); border-radius: 12px; padding: 16px; cursor: pointer; display: flex; align-items: center; gap: 12px; z-index: 10000; position: relative; -webkit-tap-highlight-color: transparent;">
                        ...
                        <div>
                            <div style="font-size: 14px; font-weight: 500; color: rgba(255,255,255,0.9); pointer-events: none;">Alle Geräte</div>
                            <div style="font-size: 12px; color: rgba(255,255,255,0.6); pointer-events: none;">45 Geräte</div>
                        </div>
                    </div>
                    
                    <div class="filter-option" data-type="automations" style="background: rgba(255,255,255,0.1); border: 2px solid transparent; border-radius: 12px; padding: 16px; cursor: pointer; display: flex; align-items: center; gap: 12px; z-index: 10000; position: relative; -webkit-tap-highlight-color: transparent;">
                        <div style="font-size: 20px; width: 32px; height: 32px; background: rgba(255,255,255,0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center;">🤖</div>
                        <div>
                            <div style="font-size: 14px; font-weight: 500; color: rgba(255,255,255,0.9); pointer-events: none;">Automationen</div>
                            <div style="font-size: 12px; color: rgba(255,255,255,0.6); pointer-events: none;">12 Verfügbar</div>
                        </div>
                    </div>
                    
                    <div class="filter-option" data-type="scripts" style="background: rgba(255,255,255,0.1); border: 2px solid transparent; border-radius: 12px; padding: 16px; cursor: pointer; display: flex; align-items: center; gap: 12px; z-index: 10000; position: relative; -webkit-tap-highlight-color: transparent;">
                        <div style="font-size: 20px; width: 32px; height: 32px; background: rgba(255,255,255,0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center;">📜</div>
                        <div>
                            <div style="font-size: 14px; font-weight: 500; color: rgba(255,255,255,0.9); pointer-events: none;">Skripte</div>
                            <div style="font-size: 12px; color: rgba(255,255,255,0.6); pointer-events: none;">8 Verfügbar</div>
                        </div>
                    </div>
                    
                    <div class="filter-option" data-type="scenes" style="background: rgba(255,255,255,0.1); border: 2px solid transparent; border-radius: 12px; padding: 16px; cursor: pointer; display: flex; align-items: center; gap: 12px; z-index: 10000; position: relative; -webkit-tap-highlight-color: transparent;">
                        <div style="font-size: 20px; width: 32px; height: 32px; background: rgba(255,255,255,0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center;">🎭</div>
                        <div>
                            <div style="font-size: 14px; font-weight: 500; color: rgba(255,255,255,0.9); pointer-events: none;">Szenen</div>
                            <div style="font-size: 12px; color: rgba(255,255,255,0.6); pointer-events: none;">15 Verfügbar</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px;">
                    ...
                    <div class="filter-option selected" data-room="" style="background: rgba(255,255,255,0.15); border: 2px solid rgba(66,133,244,1); border-radius: 12px; padding: 16px; cursor: pointer; display: flex; align-items: center; gap: 12px; z-index: 10000; position: relative; -webkit-tap-highlight-color: transparent;">
                        <div style="font-size: 20px; width: 32px; height: 32px; background: rgba(255,255,255,0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center;">🏠</div>
                        <div>
                            <div style="font-size: 14px; font-weight: 500; color: rgba(255,255,255,0.9); pointer-events: none;">Alle Räume</div>
                            <div style="font-size: 12px; color: rgba(255,255,255,0.6); pointer-events: none;">8 Räume</div>
                        </div>
                    </div>
                    
                    <div class="filter-option" data-room="Schlafzimmer" style="background: rgba(255,255,255,0.1); border: 2px solid transparent; border-radius: 12px; padding: 16px; cursor: pointer; display: flex; align-items: center; gap: 12px; z-index: 10000; position: relative; -webkit-tap-highlight-color: transparent;">
                        ...
                        <div>
                            <div style="font-size: 14px; font-weight: 500; color: rgba(255,255,255,0.9); pointer-events: none;">Schlafzimmer</div>
                            <div style="font-size: 12px; color: rgba(255,255,255,0.6); pointer-events: none;">8 Geräte</div>
                        </div>
                    </div>
                    
                    <div class="filter-option" data-room="Küche" style="background: rgba(255,255,255,0.1); border: 2px solid transparent; border-radius: 12px; padding: 16px; cursor: pointer; display: flex; align-items: center; gap: 12px; z-index: 10000; position: relative; -webkit-tap-highlight-color: transparent;">
                        <div style="font-size: 20px; width: 32px; height: 32px; background: rgba(255,255,255,0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center;">🍽️</div>
                        <div>
                            <div style="font-size: 14px; font-weight: 500; color: rgba(255,255,255,0.9); pointer-events: none;">Küche</div>
                            <div style="font-size: 12px; color: rgba(255,255,255,0.6); pointer-events: none;">12 Geräte</div>
                        </div>
                    </div>
                    
                    <div class="filter-option" data-room="Wohnzimmer" style="background: rgba(255,255,255,0.1); border: 2px solid transparent; border-radius: 12px; padding: 16px; cursor: pointer; display: flex; align-items: center; gap: 12px; z-index: 10000; position: relative; -webkit-tap-highlight-color: transparent;">
                        <div style="font-size: 20px; width: 32px; height: 32px; background: rgba(255,255,255,0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center;">🛋️</div>
                        <div>
                            <div style="font-size: 14px; font-weight: 500; color: rgba(255,255,255,0.9); pointer-events: none;">Wohnzimmer</div>
                            <div style="font-size: 12px; color: rgba(255,255,255,0.6); pointer-events: none;">15 Geräte</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="filter-actions" style="padding: 16px 24px; border-top: 1px solid rgba(255,255,255,0.1); display: flex; gap: 12px; justify-content: flex-end; flex-shrink: 0;">
            <button id="resetFiltersButton" style="background: rgba(255,255,255,0.1); color: rgba(255,255,255,0.8); border: none; border-radius: 8px; padding: 12px 24px; font-size: 14px; font-weight: 500; cursor: pointer; z-index: 10000; position: relative; -webkit-tap-highlight-color: transparent;">Zurücksetzen</button>
