...
1. Download `fast-search-card-dist.zip` from the release and unpack it — since v1.1.2431 the card ships as `fast-search-card.js` plus view chunks that must sit next to it.
