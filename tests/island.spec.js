...
// 🗑️ v1.1.2298: Der Block „Insel — Standby-Kaskade" (4 Tests) ist ENTFALLEN.
// Er prüfte die Leerlauf-Faltung (`data-ruhe="mini"` → `"alert"`), den
// ×-Knopf zum Wegschicken und das Wecken durch eine neue Meldung. Nichts davon
// existiert noch: die Insel kennt seit dem Stadien-Umbau (v2286/2289) nur
// `data-stadium` (knopf/mini/meldungen/geraete), `ruhe` ist ein abgeleitetes
// Bit mit zwei Werten, `.island-x` gibt es nicht mehr, und der Standby-Hook ist
// in v2297 als toter Code gelöscht worden. Der wertvolle Kern — eine neue
// Meldung übernimmt Zeile 2 und kondensiert in ihren Knopf — steht weiter oben
// als eigener Test („eine neue Meldung übernimmt kurz …").
